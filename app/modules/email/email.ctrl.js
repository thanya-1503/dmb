                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="center" style="padding-bottom: 15px;">
                            <table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="img" width="70" height="70"
                                  style="font-size:0pt; line-height:0pt; text-align:left;">
                                  <a href="#" target="_blank"><img
                                      src="https://entronica.co.th/assets/img/logo.png" width="100"
                        ...
                        <tr>
                          <td class="text-footer1 pb10"
                            style="color:#800000; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; padding-bottom:10px;font-weight: 700;">
                            Entronica Co,ltd.</td>
                        </tr>
                        <tr>
                          <td class="text-footer2"
                            style="color:#8297b3; font-family:'Muli', Arial,sans-serif; font-size:12px; line-height:20px; text-align:center;padding-top: 10px;">
